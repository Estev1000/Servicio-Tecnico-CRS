// --- TALLER PRO MANAGEMENT LOGIC ---

document.addEventListener('DOMContentLoaded', () => {
    // --- Data Management ---
    let inventory = JSON.parse(localStorage.getItem('repuestospos_inventory')) || [
        { id: 1, code: 'GAS-R134A', name: 'Carga de Gas R134a', brand: 'Refrigerante', category: 'Gas Refrigerante', price: 25000, stock: 999 },
        { id: 2, code: 'GAS-R600A', name: 'Carga de Gas R600a', brand: 'Refrigerante', category: 'Gas Refrigerante', price: 30000, stock: 999 },
        { id: 3, code: 'MANT-PREV', name: 'Mantenimiento Preventivo General', brand: 'CRS', category: 'Mantenimiento', price: 15000, stock: 999 },
        { id: 4, code: 'INST-001', name: 'Instalación de Aire Acondicionado', brand: 'CRS', category: 'Instalación', price: 35000, stock: 999 },
        { id: 5, code: 'REP-COMP', name: 'Reparación de Compresor', brand: 'CRS', category: 'Reparación', price: 20000, stock: 999 },
        { id: 6, code: 'FILT-SEC', name: 'Filtro Deshidratante', brand: 'Emerson', category: 'Repuestos', price: 8500, stock: 15 }
    ];
    ...
    let config = JSON.parse(localStorage.getItem('repuestospos_config')) || {
        storeName: 'Servicio Técnico CRS',
        storeSlogan: 'Reparación de Heladeras | Mantenimiento | Instalación | Carga de Gas',
        taxId: '',
        address: '',
        taxPercent: 21
    };
    ...
    function switchView(viewName) {
        ...
        const menuOpens = document.querySelectorAll('.mobile-menu-toggle');
        ...
        // Sidebar link click handling for mobile
    ...
    function downloadTurnoStatusImage() {
        ...
        ctx.fillText('SERVICIO TECNICO CRS', 500, 110);
        ctx.fillText('REPARACION DE HELADERAS', 500, 155);
        ...
        ctx.font = '25px Arial';
        ctx.fillText('Servicio Técnico CRS - Reparación de Heladeras', 500, 920);
    ...
    document.querySelectorAll('.quick-sale-btn, #quick-sale-btn').forEach(btn => {
        btn.addEventListener('click', () => switchView('Venta normal'));
    });
    ...
    document.getElementById('export-json').onclick = () => {
        ...
        downloadFile(JSON.stringify(fullData, null, 2), `CRS_Backup_${new Date().toISOString().split('T')[0]}.json`, 'application/json');
    ...
    document.getElementById('export-excel').onclick = () => {
        ...
        XLSX.writeFile(workbook, `CRS_Backup_${new Date().toISOString().split('T')[0]}.xlsx`);
